...
export const seoData = [
    ...
    // 1학년 상세
    { path: '/grade/1/number-counting', title: '1학년 수학: 9까지의 수 세기', description: '9까지의 수를 세어보고 크기를 비교합니다. 시각적인 도구로 수의 개념을 재미있게 익혀요.', keywords: '1학년수학, 수세기, 숫자세기, 9까지의수', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/1/shapes', title: '1학년 수학: 여러 가지 모양 찾기', description: '동그라미, 세모, 네모 모양을 찾아보며 평면도형의 기초를 배웁니다.', keywords: '1학년모양, 도형기초, 여러가지모양', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/1/arithmetic', title: '1학년 수학: 기초 덧셈과 뺄셈', description: '모으기와 가르기를 통해 덧셈과 뺄셈의 기본 원리를 이해합니다.', keywords: '1학년연산, 모으기가르기, 덧셈뺄셈기초', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/1/number-50', title: '1학년 수학: 50까지의 수', description: '10개씩 묶음과 낱개로 50까지의 수를 이해하고 세는 방법을 배웁니다.', keywords: '1학년수학, 50까지의수, 수세기', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/1/clock', title: '1학년 수학: 시계 보기와 규칙 찾기', description: '정각과 30분 단위의 시계 보는 법과 기초적인 규칙 찾기를 학습합니다.', keywords: '1학년시계, 시간보기, 규칙찾기', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/1/number-100', title: '1학년 수학: 100까지의 수', description: '100까지의 수 체계를 익히고 크기를 비교하는 방법을 배웁니다.', keywords: '1학년수학, 100까지의수, 수의크기', priority: 0.7, changefreq: 'weekly' },
    ...
    // 2학년 상세
    { path: '/grade/2/three-digit', title: '2학년 수학: 세 자리 수 이해하기', description: '백, 십, 일의 자리를 배우고 세 자리 수의 크기를 비교합니다.', keywords: '2학년수학, 세자리수, 자릿수', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/2/shapes', title: '2학년 수학: 여러 가지 도형 (삼각형, 사각형)', description: '삼각형, 사각형의 특징을 배우고 선분과 꼭짓점을 이해합니다.', keywords: '2학년도형, 삼각형, 사각형', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/2/arithmetic', title: '2학년 수학: 두 자리 수의 덧셈과 뺄셈', description: '받아올림과 받아내림이 있는 연산의 원리를 익힙니다.', keywords: '2학년연산, 받아올림, 받아내림', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/2/length', title: '2학년 수학: 길이 재기 (cm/m)', description: '센티미터와 미터 단위의 차이를 알고 길이를 재는 법을 배웁니다.', keywords: '2학년길이재기, 측정, 단위', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/2/four-digit', title: '2학년 수학: 네 자리 수 이해하기', description: '천의 자리까지 수의 개념을 확장하고 명수법을 학습합니다.', keywords: '2학년수학, 네자리수, 천의자리', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/2/multiplication', title: '2학년 수학: 곱셈과 구구단', description: '곱셈의 원리를 이해하고 구구단을 즐겁게 익힙니다.', keywords: '2학년곱셈, 구구단, 묶어세기', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/2/time', title: '2학년 수학: 시각과 시간', description: '몇 시 몇 분을 읽고 시간의 흐름을 이해합니다.', keywords: '2학년시계, 시간계산, 시각', priority: 0.7, changefreq: 'weekly' },
    ...
    // 4학년 상세
    { path: '/grade/4/large-numbers', title: '4학년 수학: 수조 단위 큰 수', description: '만, 억, 조 단위의 수를 읽고 쓰는 법을 완벽히 마스터합니다.', keywords: '4학년수학, 큰수, 억단위, 조단위', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/angles', title: '4학년 수학: 각도의 합과 차', description: '각도기를 사용한 각 측정과 각의 연산을 배웁니다.', keywords: '4학년각도, 각도학습, 측정', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/arithmetic', title: '4학년 수학: 수의 곱셈과 나눗셈', description: '복잡한 세 자리 수 곱셈과 두 자리 수 나눗셈을 원리로 익힙니다.', keywords: '4학년연산, 세자리수곱셈, 나눗셈', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/fraction', title: '4학년 수학: 분수의 덧셈과 뺄셈', description: '진분수와 대분수의 연산을 그림과 수식으로 배웁니다.', keywords: '4학년분수, 분수연산, 대분수', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/line-graph', title: '4학년 수학: 꺾은선그래프', description: '데이터의 변화를 꺾은선그래프로 나타내고 분석합니다.', keywords: '4학년그래프, 꺾은선그래프, 통계', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/geometry-move', title: '4학년 수학: 평면도형의 이동', description: '도형의 밀기, 뒤집기, 돌리기를 시각적으로 학습합니다.', keywords: '도형이동, 뒤집기, 돌리기', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/bar-graph', title: '4학년 수학: 막대그래프', description: '데이터를 막대그래프로 정리하고 읽는 법을 배웁니다.', keywords: '막대그래프, 그래프공부, 통계기초', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/rules', title: '4학년 수학: 규칙 찾기와 배열', description: '수의 배열이나 모양의 변화에서 규칙을 찾아 식으로 나타냅니다.', keywords: '규칙찾기, 수의배열, 연산규칙', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/triangle', title: '4학년 수학: 삼각형의 종류', description: '이등변삼각형, 정삼각형, 예각/둔각삼각형을 구별하고 특징을 배웁니다.', keywords: '삼각형, 이등변삼각형, 정삼각형', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/decimal', title: '4학년 수학: 소수의 덧셈과 뺄셈', description: '소수 두 자리 수, 세 자리 수의 개념과 연산을 익힙니다.', keywords: '4학년소수, 소수연산, 소수개념', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/quadrilateral', title: '4학년 수학: 여러 가지 사각형', description: '사다리꼴, 평행사변형, 마름모의 정의와 성질을 학습합니다.', keywords: '사각형, 평행사변형, 마름모', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/4/polygons', title: '4학년 수학: 다각형과 대각선', description: '다각형의 정의와 대각선의 성질을 배우고 모양을 탐색합니다.', keywords: '다각형, 대각선, 도형의성질', priority: 0.7, changefreq: 'weekly' },
    ...
    // 5학년 상세
    { path: '/grade/5/mixed-arithmetic', title: '5학년 수학: 복합 사칙연산', description: '계산 순서에 주의하며 사칙연산 혼합 계산을 연습합니다.', keywords: '5학년연산, 혼합계산, 순서', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/factors-multiples', title: '5학년 수학: 약수와 배수', description: '최대공약수와 최소공배수를 구하는 원리와 활용을 배웁니다.', keywords: '약수, 배수, 최대공약수, 최소공배수', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/fraction-arithmetic', title: '5학년 수학: 분수의 약분과 통분', description: '분모가 다른 분수의 덧셈과 뺄셈을 위해 꼭 필요한 개념을 학습합니다.', keywords: '통분, 약분, 다른분모분수', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/area', title: '5학년 수학: 다각형의 둘레와 넓이', description: '다각형의 넓이 공식을 유도하고 계산해봅니다.', keywords: '5학년넓이, 도형공식, 면적계산', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/rules', title: '5학년 수학: 규칙과 대응', description: '두 양 사이의 대응 관계를 파악하고 식으로 나타냅니다.', keywords: '규칙과대응, 대응관계, 함수기초', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/reduction', title: '5학년 수학: 분수의 덧셈과 뺄셈 (심화)', description: '통분을 활용한 분수의 고급 연산을 연습합니다.', keywords: '분수심화, 통분연산, 분수합차', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/range', title: '5학년 수학: 범위와 어림하기', description: '이상, 이하, 초과, 미만의 개념과 올림, 버림, 반올림을 배웁니다.', keywords: '수의범위, 올림버림반올림, 어림하기', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/fraction-multiplication', title: '5학년 수학: 분수의 곱셈', description: '분수와 자연수, 분수와 분수의 곱셈 원리를 학습합니다.', keywords: '분수곱셈, 분수의계산, 연산', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/congruence', title: '5학년 수학: 합동과 대칭', description: '도형의 합동과 선대칭, 점대칭 도형의 성질을 배웁니다.', keywords: '합동, 선대칭, 점대칭, 도형성질', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/decimal-multiplication', title: '5학년 수학: 소수의 곱셈', description: '소수의 곱셈 원리를 소수점 위치 변화와 함께 이해합니다.', keywords: '소수곱셈, 소수점위치, 연산', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/cuboid', title: '5학년 수학: 직육면체와 정육면체', description: '입체도형의 기초인 직육면체의 구성 요소와 성질을 배웁니다.', keywords: '직육면체, 정육면체, 겨냥도, 전개도', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/5/average', title: '5학년 수학: 평균과 가능성', description: '평균을 구하고 일어날 가능성을 수로 표현해봅니다.', keywords: '평균구하기, 확률기초, 가능성', priority: 0.7, changefreq: 'weekly' },
    ...
    // 6학년 상세
    { path: '/grade/6/fraction-division', title: '6학년 수학: 분수의 나눗셈', description: '분수의 나눗셈이 곱셈으로 변하는 원리를 완벽하게 이해합니다.', keywords: '분수나눗셈, 역수곱셈, 6학년수학', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/6/decimal-division', title: '6학년 수학: 소수의 나눗셈', description: '소수점 위치를 옮겨가며 정교하게 계산하는 법을 배웁니다.', keywords: '소수나눗셈, 나누기, 연산원리', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/6/ratio', title: '6학년 수학: 비와 비율, 백분율', description: '비율과 백분율의 실생활 활용과 개념을 마스터합니다.', keywords: '비와비율, 백분율, 퍼센트, 기준량', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/6/circle-area', title: '6학년 수학: 원의 넓이와 원주율', description: '원주율의 개념과 원의 넓이 계산 공식을 학습합니다.', keywords: '원의넓이, 원주율, 지름, 반지름', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/6/geometry', title: '6학년 수학: 각기둥과 각뿔', description: '각기둥과 각뿔의 특징을 비교하고 입체도형을 이해합니다.', keywords: '각기둥, 각뿔, 입체도형, 전개도', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/6/graphs', title: '6학년 수학: 띠그래프와 원그래프', description: '비율을 나타내는 여러 가지 그래프를 해석하고 그립니다.', keywords: '띠그래프, 원그래프, 비율그래프', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/6/volume', title: '6학년 수학: 직육면체의 부피와 겉넓이', description: '입체도형의 크기를 나타내는 부피와 겉넓이 구하는 법을 배웁니다.', keywords: '부피구하기, 겉넓이, 입체도형측정', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/6/proportion', title: '6학년 수학: 비례식과 비례배분', description: '비의 성질을 이용한 비례식과 비례배분 원리를 배웁니다.', keywords: '비례식, 비례배분, 비율활용', priority: 0.7, changefreq: 'weekly' },
    { path: '/grade/6/round-geometry', title: '6학년 수학: 원기둥, 원뿔, 구', description: '회전체인 원기둥, 원뿔, 구의 개념과 성질을 학습합니다.', keywords: '원기둥, 원뿔, 구, 회전체', priority: 0.7, changefreq: 'weekly' },
