...
const Grade1Quiz = () => {
    ...
    const generateProblem = () => {
        const topics = ['counting', 'addition', 'subtraction', 'numbers-50', 'clock'];
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                <h2 className={styles.title}>1학년 종합 퀴즈왕 👑</h2>
